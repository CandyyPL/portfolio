...
export default function About() {
  return (
    <section
      ...
      <h1 className='section-heading text-center md:w-full md:pr-10 md:text-end'>
      ...
      <div className='flex w-full flex-col items-center gap-8 md:flex-row md:justify-center'>
        <img
          src='/profile2.webp'
          alt='photo'
          className='border-yellow-dim max-h-120 rounded-md border-4'
        />
        <div className='flex w-fit flex-col items-center gap-8'>
          <div className='bg-background-light text-light-dim font-poppins relative rounded-sm p-4 text-sm opacity-80 md:max-w-150 md:text-lg xl:max-w-175 xl:text-xl'>
            ...
            />
            <p className='relative z-1 mb-2 w-2/3 font-medium text-balance'>
              Wybierz pracę, którą kochasz, a nie przepracujesz ani jednego dnia
              w swoim życiu.
            </p>
            <p className='w-full text-end'>Konfucjusz</p>
          </div>
          <p className='text-light px-4 text-center text-lg leading-tight md:max-w-150 md:text-xl xl:max-w-175 xl:text-xl'>
